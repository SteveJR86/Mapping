...
for row, properties in enumerate(neighbourhoodsProperties, start=1):
  ...
  worksheet.write(row, 7, nonFSAProps/nonFSAPropsMinted, percentage_format)
...
worksheet.write(len(neighbourhoodsProperties)+2, 1, len(properties))
worksheet.write(len(neighbourhoodsProperties)+2, 2, propsUnlocked)
worksheet.write(len(neighbourhoodsProperties)+2, 3, propsMinted)
worksheet.write(len(neighbourhoodsProperties)+2, 4, propsMinted/propsUnlocked, percentage_format)
worksheet.write(len(neighbourhoodsProperties)+2, 5, nonFSAProps)
worksheet.write(len(neighbourhoodsProperties)+2, 6, nonFSAPropsMinted)
worksheet.write(len(neighbourhoodsProperties)+2, 7, nonFSAProps/nonFSAPropsMinted, percentage_format)
